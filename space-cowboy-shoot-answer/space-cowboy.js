! function() {
    ...
    function F(e, t, n, i) {
        e.addEventListener(n, function(n) {
            for (var o = n.target; o && o !== e;) {
                o.matches(t) && i.call(o, n, o), o = o.parentNode;
            }
        });
    }
    ...
    var $e = document.querySelector(".space-cowboy__arm"),
        ...
        We = document.querySelector(".container"),
        ze = void 0,
        Fe = !1,
        Ue = void 0;
    ...
    function Ge() {
        if (!Ue) {
            if (!Fe) {
                return Pe.style.opacity = 1, Pe.style.animationPlayState = "running", void(Fe = !0);
            }
